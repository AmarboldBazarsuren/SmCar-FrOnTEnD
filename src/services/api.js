...
export const getListingById  = (id)          => api.get(`/listings/${id}`).then((r) => r.data);
...
export const createAdminListing = (body)      => api.post('/admin/listings', body).then((r) => r.data);
export const updateAdminListing = (id, body)  => api.put(`/admin/listings/${id}`, body).then((r) => r.data);
export const deleteAdminListing = (id)        => api.delete(`/admin/listings/${id}`).then((r) => r.data);